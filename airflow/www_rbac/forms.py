...
from flask_appbuilder.fieldwidgets import (
    ...
    Select2Widget, DateTimePickerWidget)
...
class DagRunForm(DynamicForm):
    ...
    start_date = DateTimeField(
        lazy_gettext('Start Date'), widget=DateTimePickerWidget())
    end_date = DateTimeField(
        lazy_gettext('End Date'), widget=DateTimePickerWidget())
    ...
    execution_date = DateTimeField(
        lazy_gettext('Execution Date'), widget=DateTimePickerWidget())
...
class ConnectionForm(DynamicForm):
    ...
    port = IntegerField(
        ...
        widget=BS3TextFieldWidget())
    extra = TextAreaField(
        lazy_gettext('Extra'), widget=BS3TextAreaFieldWidget())
