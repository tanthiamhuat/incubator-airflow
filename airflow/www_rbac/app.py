...
def create_app(config=None, session=None, testing=False, app_name="Airflow"):
    ...
    with app.app_context():
        ...
        security_manager_class = (
            app.config.get("SECURITY_MANAGER_CLASS") or AirflowSecurityManager
        )
        ...
        def init_views(appbuilder):
            ...
            appbuilder.add_view(
                views.TaskInstanceModelView, "Task Instances", category="Browse"
            )
            appbuilder.add_link(
                "Configurations",
                href="/configuration",
            ...
            appbuilder.add_link(
                "Version", href="/version", category="About", category_icon="fa-th"
            )
