...
class DatastoreHook(GoogleCloudBaseHook):
    ...
    def __init__(
        self, datastore_conn_id="google_cloud_datastore_default", delegate_to=None
    ):
    ...
    def allocate_ids(self, partialKeys):
        ...
        resp = (
            ...
            .allocateIds(projectId=self.project_id, body={"keys": partialKeys})
            .execute()
        )
        return resp["keys"]
    ...
    def poll_operation_until_done(self, name, polling_interval_in_seconds):
        ...
        while True:
            ...
            if state == "PROCESSING":
                self.log.info(
                    "Operation is processing. Re-polling state in {} seconds".format(
    ...
    def export_to_storage_bucket(
        self, bucket, namespace=None, entity_filter=None, labels=None
    ):
        """
        ...
        resp = (
            self.admin_connection.projects()
    ...
    def import_from_storage_bucket(
        self, bucket, file, namespace=None, entity_filter=None, labels=None
    ):
        """
