...
def initdb(rbac=False):
    ...
    merge_conn(
        models.Connection(
            conn_id="hive_cli_default", conn_type="hive_cli", schema="default"
        )
    )
    merge_conn(
        models.Connection(
    ...
    merge_conn(
        models.Connection(
            conn_id="mongo_default", conn_type="mongo", host="localhost", port=27017
        )
    )
    merge_conn(
        models.Connection(
            conn_id="mysql_default", conn_type="mysql", login="root", host="localhost"
        )
    )
    merge_conn(
        models.Connection(
    ...
    merge_conn(
        models.Connection(conn_id="ssh_default", conn_type="ssh", host="localhost")
    )
    merge_conn(
        models.Connection(
    ...
    merge_conn(
        models.Connection(conn_id="fs_default", conn_type="fs", extra='{"path": "/"}')
    )
    merge_conn(
        models.Connection(
    ...
    merge_conn(
        models.Connection(
            conn_id="sqoop_default", conn_type="sqoop", host="rmdbs", extra=""
        )
    )
    merge_conn(
        models.Connection(
    ...
    merge_conn(
        models.Connection(
            conn_id="qubole_default", conn_type="qubole", host="localhost"
        )
    )
    merge_conn(
        models.Connection(
    ...
    if (
        not session.query(KET)
        .filter(KET.know_event_type == "Marketing Campaign")
        .first()
    ):
