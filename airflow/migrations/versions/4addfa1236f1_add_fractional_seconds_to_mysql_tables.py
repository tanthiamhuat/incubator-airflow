...
def downgrade():
    if context.config.get_main_option("sqlalchemy.url").startswith("mysql"):
        op.alter_column(
            table_name="dag", column_name="last_scheduler_run", type_=mysql.DATETIME()
        )
        op.alter_column(
        ...
        op.alter_column(
            table_name="dag_pickle", column_name="created_dttm", type_=mysql.DATETIME()
        )

        op.alter_column(
            table_name="dag_run", column_name="execution_date", type_=mysql.DATETIME()
        )
        op.alter_column(
        ...
        op.alter_column(
            table_name="import_error", column_name="timestamp", type_=mysql.DATETIME()
        )
        ...
        op.alter_column(
            table_name="job", column_name="latest_heartbeat", type_=mysql.DATETIME()
        )

        op.alter_column(
            table_name="known_event", column_name="start_date", type_=mysql.DATETIME()
        )
        op.alter_column(
            table_name="known_event", column_name="end_date", type_=mysql.DATETIME()
        )
        ...
        op.alter_column(
            table_name="sla_miss", column_name="timestamp", type_=mysql.DATETIME()
        )

        op.alter_column(
            table_name="task_fail", column_name="execution_date", type_=mysql.DATETIME()
        )
        op.alter_column(
            table_name="task_fail", column_name="start_date", type_=mysql.DATETIME()
        )
        op.alter_column(
        ...
        op.alter_column(
            table_name="task_instance", column_name="start_date", type_=mysql.DATETIME()
        )
        op.alter_column(
            table_name="task_instance", column_name="end_date", type_=mysql.DATETIME()
        )
        op.alter_column(
            table_name="task_instance",
            column_name="queued_dttm",
        ...
        op.alter_column(
            table_name="xcom", column_name="timestamp", type_=mysql.DATETIME()
        )
        op.alter_column(
